          ...
          <form>
            ...
            <div class="login-form-body">
              <div class="form-gp">
                ...
                <input class="form-control" type="email" id="exampleInputEmail1" placeholder="Your Email address" />
                <!-- <i class="ti-email"></i> -->
              </div>
              ...
              <div class="submit-btn-area">
                ...
                <div class="login-other row mt-4">
                  <div class="col-6 facebook">
                    <a class="fb-login" href="#">Log in with
                      <span style="
                        font-weight: bold;
                        font-size: 15px;
                  ...
                  <div class="col-6 google">
                    <a class="google-login" href="#">Log in with
